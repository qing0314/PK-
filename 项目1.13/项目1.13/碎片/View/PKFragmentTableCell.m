...
//通过set方法，在counterList刚被赋值是对其他控件进行赋值
- (void)setCounterList:(PKFragmentList *)counterList
{
    ...
    //加载网络图片方法(UIImageView + SDWebImage)中
...
- (NSAttributedString *)makeText:(NSString *)exampleString
{
    ...
    NSDictionary *dictA = @{NSFontAttributeName:[UIFont fontWithName:@"PingFangSC-Regular" size:15.0],
